      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          ...
          <property name="SocietaList" class="AttributeAssignment">
            <property name="attributeValue" class="String">EO;AI;AK;AA;AR;SC;TH;TE</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="38">
        <property name="name" class="String" id="39">Execute Command Line</property>
...
"net use "+ ConfWriteFile.Letter + ": \""+ ConfWriteFile.Root + "\" /user:" + ConfWriteFile.User + " " + ConfWriteFile.Password</property>
      ...
      <object class="Transition" serializationversion="3" id="44">
        <property name="name" class="String" id="45">Set Current Window</property>
        ...
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
          ...
          <property name="controlFlow" class="kapow.robot.robomaker.robot.ControlFlow$NextIteration">
            <property name="targetStepSelector" class="kapow.robot.robomaker.robot.ControlFlow$TargetStepSelector">
              <property name="name" class="String" id="56">For Each Option</property>
            </property>
          </property>
        </property>
        <property name="comment">
      ...
      <object class="Transition" serializationversion="3" id="61">
        <property name="name" class="String" id="62">Set Named Tag</property>
        <property name="stepAction" class="SetNamedTag" serializationversion="0">
          <property name="tagName" class="DesiredElementName">
            <property name="name" class="String" id="63">RecapitiModal</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
      ...
      <object class="Transition" serializationversion="3" id="69">
        <property name="name" class="String" id="70">For Each Tag Path</property>
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            <property name="nodePath" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
              <property name="value" class="String">.*.div.div.div.div.div.div.div.div.div.div.div.ul.li[1].table</property>
            </property>
            <property name="attributeName" class="String">class</property>
            <property name="attributeValue" class="kapow.robot.plugin.common.support.predicate.unary.string.FixedStringPredicate">
              <property name="text" class="String">base_big</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
      ...
      <object class="Transition" serializationversion="3" id="74">
        <property name="name" class="String" id="75">Enter Text</property>
        <property name="stepAction" class="EnterText">
      ...
      <object class="Transition" serializationversion="3" id="76">
        <property name="name" class="String" id="77">Press Key</property>
      ...
      <object class="Transition" serializationversion="3" id="82">
        ...
        <property name="stepAction" class="SetNamedTag" serializationversion="0">
          <property name="tagName" class="DesiredElementName">
            <property name="name" class="String" id="83">Error</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
      ...
      <object class="Transition" serializationversion="3" id="102">
        <property name="name" class="String" id="103">Write File</property>
