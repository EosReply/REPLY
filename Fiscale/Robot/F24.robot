...
<object class="Robot" serializationversion="2">
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="8">societaReport</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="3"/>
      </property>
    ...
    <object class="Variable" serializationversion="1">
      ...
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0" id="9">
        ...
        <property name="assignments" class="AttributeAssignments">
          <property name="Letter" class="AttributeAssignment">
            ...
            <property name="lastKnownAttributeType" class="java.lang.Class" id="10">kapow.robot.plugin.common.domain.StringAttributeType</property>
          </property>
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          <property name="DataA" class="AttributeAssignment">
            <property name="attributeValue" class="String">2019-12-15 10:32:00.858</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" class="java.lang.Class" id="21">kapow.robot.plugin.common.domain.DateAttributeType</property>
          </property>
          <property name="DataDa" class="AttributeAssignment">
            <property name="attributeValue" class="String">2019-11-01 10:31:56.965</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" idref="21"/>
          </property>
          <property name="Password" class="AttributeAssignment">
            ...
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" class="java.lang.Class" id="22">kapow.robot.plugin.common.domain.PasswordAttributeType</property>
          </property>
...
"net use "+ ConfWriteFile.Letter + ": \""+ ConfWriteFile.Root + "\" /user:" + ConfWriteFile.User + " " + ConfWriteFile.Password</property>
      ...
      <object class="Transition" serializationversion="3" id="45">
        <property name="name" class="String" id="46">Write File</property>
...
"net use "+ ConfWriteFile.Letter + ": \""+ ConfWriteFile.Root + "\" /user:" + ConfWriteFile.User + " " + ConfWriteFile.Password</property>
      ...
      <object class="Transition" serializationversion="3" id="57">
        <property name="name" class="String" id="58">Set Current Window</property>
        ...
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
          ...
          <property name="controlFlow" class="kapow.robot.robomaker.robot.ControlFlow$NextIteration">
            <property name="targetStepSelector" class="kapow.robot.robomaker.robot.ControlFlow$TargetStepSelector">
              <property name="name" class="String" id="73">For Each Option</property>
            </property>
          </property>
        </property>
        <property name="comment">
      ...
      <object class="Transition" serializationversion="3" id="78">
        ...
        <property name="stepAction" class="SetNamedTag" serializationversion="0">
          <property name="tagName" class="DesiredElementName">
            <property name="name" class="String" id="79">RecapitiModal</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
      ...
      <object class="Transition" serializationversion="3" id="90">
        <property name="name" class="String" id="91">Enter Text</property>
        <property name="stepAction" class="EnterText">
      ...
      <object class="Transition" serializationversion="3" id="92">
        <property name="name" class="String" id="93">Press Key</property>
      ...
      <object class="Transition" serializationversion="3" id="98">
        ...
        <property name="stepAction" class="SetNamedTag" serializationversion="0">
          <property name="tagName" class="DesiredElementName">
            <property name="name" class="String" id="99">Error</property>
          </property>
        </property>
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
