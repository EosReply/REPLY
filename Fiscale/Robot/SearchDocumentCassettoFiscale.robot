...
<object class="Robot" serializationversion="2">
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          ...
          <property name="endDate" class="AttributeAssignment">
            ...
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" class="java.lang.Class" id="4">kapow.robot.plugin.common.domain.DateAttributeType</property>
          </property>
  ...
  "user": "&lt;&lt;+cassettoFiscaleSearchRequest.login+&gt;&gt;",
