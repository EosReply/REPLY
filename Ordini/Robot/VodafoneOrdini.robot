...
<object class="Robot" serializationversion="2">
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="1">orderDateList</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="SimpleTypeReference">
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          ...
          <property name="soggetto" class="AttributeAssignment">
            <property name="attributeValue" class="String">RPA - VodafoneOrdini</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" idref="2"/>
          </property>
        </property>
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          ...
          <property name="Root" class="AttributeAssignment">
            <property name="attributeValue" class="String">C:\EOS\Temporary\vodafone</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" idref="2"/>
          </property>
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          <property name="dayBefore" class="AttributeAssignment">
            <property name="attributeValue" class="String">3</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" idref="3"/>
          </property>
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="10">orderDate</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="4"/>
      </property>
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="11">errorResult</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="SimpleTypeReference">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="12">countDownload</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="6"/>
        <property name="assignments" class="AttributeAssignments">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="13">credentialError</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="6"/>
        <property name="assignments" class="AttributeAssignments">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="14">orderReturn</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" class="TypeReference" serializationversion="0">
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      ...
      <object class="Transition" serializationversion="3" id="19">
        <property name="name" class="String" id="20">Send Email</property>
...
"Robot Message: Inizio Esecuzione."</property>
      ...
      <object class="Transition" serializationversion="3" id="24">
        <property name="name" class="String" id="25">Test Value</property>
      ...
      <object class="Transition" serializationversion="3" id="40">
        <property name="name" class="String" id="41">For Each Order Date</property>
      ...
      <object class="Transition" serializationversion="3" id="48">
        <property name="name" class="String" id="49">Query Database</property>
      ...
      <object class="Transition" serializationversion="3" id="51">
        ...
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
          <property name="changedProperties" class="java.util.HashSet">
            <element class="String" id="52">reportingViaAPI</element>
            <element class="String" id="53">reportingViaLog</element>
          </property>
          <property name="reportingViaAPI" class="Boolean">false</property>
          <property name="reportingViaLog" class="Boolean">false</property>
          <property name="controlFlow" class="kapow.robot.robomaker.robot.ControlFlow$NextAlternative"/>
      ...
      <object class="Transition" serializationversion="3" id="61">
        <property name="name" class="String" id="62">Test File Existence</property>
    ...
    "Path": "&lt;&lt;+urlEncode(orderValue.year+&gt;&gt;/&lt;&lt;+configurationVodafone.rootOutputSubfolder+&gt;&gt;/&lt;&lt;+orderValue.month)+&gt;&gt;",
    "PathSharepoint": "&lt;&lt;+urlEncode(configurationVodafone.sharePointFolder)+&gt;&gt;",  
"ListName": "&lt;&lt;+configurationVodafone.listName+&gt;&gt;",
 "Filename": "&lt;&lt;+orderValue.number+"_VODAFONE_"+day(orderValue.date)+(length(month(orderValue.date))==1?"0"+month(orderValue.date):month(orderValue.date))+year(orderValue.date)+".pdf"+&gt;&gt;",
   "User": "&lt;&lt;+configurationVodafone.user+&gt;&gt;",
   "Domain": "&lt;&lt;+configurationVodafone.domain+&gt;&gt;",
  "Password": "&lt;&lt;+configurationVodafone.password+&gt;&gt;"
          ...
          <property name="inputValueExpression" class="kapow.robot.plugin.common.stepaction.rl2.InputValueBeanList">
            ...
            <object class="kapow.robot.plugin.common.stepaction.rl2.InputValue">
              <property name="inputValueExpression" class="Expression" serializationversion="1">
                <property name="text" class="String">ConfigurationWriteFileTemp.Root+"\\"+orderValue.number+"_VODAFONE_"+day(orderValue.date)+(length(month(orderValue.date))==1?"0"+month(orderValue.date):month(orderValue.date))+year(orderValue.date)+".pdf"</property>
              </property>
            </object>
          </property>
          <property name="outputVariables" class="kapow.robot.plugin.common.stepaction.rl2.OutputVariableBeanList">
  ...
  "Binary": "&lt;&lt;+base64Encode(binary)+&gt;&gt;"
      ...
      <object class="Transition" serializationversion="3" id="74">
        <property name="name" class="String" id="75">Delete File</property>
      ...
      <object class="Transition" serializationversion="3" id="77">
        <property name="name" class="String" id="78">Set Current Window</property>
      ...
      <object class="Transition" serializationversion="3" id="92">
        <property name="name" class="String" id="93">Return Value</property>
      ...
      <object class="Transition" serializationversion="3" id="97">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
            <property name="value" class="String">Errore durante il salvataggio su Sharepoint</property>
          </property>
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">orderReturn.result</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="102">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
            <property name="value" class="String">Ordine già presente in folder</property>
          </property>
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">orderReturn.result</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="106">
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.stringexpr.ValueStringExpression">
            <property name="value" class="String">Ordine già presente a database (già scaricato)</property>
          </property>
          <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
            <property name="name" class="String">orderReturn.result</property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="145">
        <property name="name" class="String">Select Option 40 Risultati pagina</property>
        <property name="stepAction" class="SelectOption">
          <property name="optionValueExpression" class="kapow.robot.plugin.common.support.form.misc.fieldvalue.expression.SelectedSelectFieldValueStringExpression">
            <property name="fieldValue" class="kapow.robot.plugin.common.support.form.misc.fieldvalue.FieldValue">
              <property name="value" class="String">40</property>
              <property name="displayName" class="String">40</property>
        ...
        <property name="elementFinders" class="ElementFinders">
          <object class="DefaultNamedElementAwareDOMElementFinder" serializationversion="4">
            ...
            <property name="attributeName" class="String" id="146">name</property>
            <property name="attributeValue" class="kapow.robot.plugin.common.support.predicate.unary.string.FixedStringPredicate">
              <property name="text" class="String">max</property>
            </property>
          </object>
        </property>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
      ...
      <object class="BranchPoint" id="149"/>
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.multipletype.StringProcessorsExpression" serializationversion="0">
            <property name="dataConverters" class="DataConverters">
              <element class="GetVariable" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String" id="155">orderDateString</property>
                </property>
              </element>
        ...
        <property name="stepAction" class="CallRESTWebService2" serializationversion="1">
          ...
          <property name="request" class="kapow.robot.plugin.common.stateprocessor.rest.PostRestRequest">
            <property name="body" class="kapow.robot.plugin.common.stateprocessor.rest.RawBodyContent">
              <property name="data" class="Expression" serializationversion="1">
                <property name="text" class="String">&gt;&gt;{
    "Path": "&lt;&lt;+urlEncode(year(orderReturn.orderDate)+&gt;&gt;/&lt;&lt;+configurationVodafone.rootOutputSubfolder+&gt;&gt;/&lt;&lt;+orderMonthLetter)+&gt;&gt;",
    "PathSharepoint": "&lt;&lt;+urlEncode(configurationVodafone.sharePointFolder)+&gt;&gt;",  
"ListName": "&lt;&lt;+configurationVodafone.listName+&gt;&gt;",
 "Filename": "&lt;&lt;+orderReturn.orderNumber+"_VODAFONE_"+day(orderReturn.orderDate)+(length(month(orderReturn.orderDate))==1?"0"+month(orderReturn.orderDate):month(orderReturn.orderDate))+year(orderReturn.orderDate)+".pdf"+&gt;&gt;",
   "User": "&lt;&lt;+configurationVodafone.user+&gt;&gt;",
   "Domain": "&lt;&lt;+configurationVodafone.domain+&gt;&gt;",
  "Password": "&lt;&lt;+configurationVodafone.password+&gt;&gt;"
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.multipletype.StringProcessorsExpression" serializationversion="0">
            <property name="dataConverters" class="DataConverters">
              <element class="GetVariable" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String" id="167">urlPdfDownload</property>
                </property>
              </element>
              <element class="AdvancedExtract2">
                <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PatternValueStringExpression">
   ...
   "Domain": "&lt;&lt;+configurationVodafone.domain+&gt;&gt;",
  "Password": "&lt;&lt;+configurationVodafone.password+&gt;&gt;",
  "Binary": "&lt;&lt;+base64Encode(pdfDownload)+&gt;&gt;"
}&lt;&lt;</property>
              </property>
              <property name="contentType" class="kapow.robot.plugin.common.support.mimetype.MIMETypeValueStringExpression">
                <property name="value" class="String">application/octet-stream</property>
        ...
        <property name="stepAction" class="CallRESTWebService2" serializationversion="1">
          ...
          <property name="request" class="kapow.robot.plugin.common.stateprocessor.rest.PostRestRequest">
            <property name="body" class="kapow.robot.plugin.common.stateprocessor.rest.RawBodyContent">
              <property name="data" class="Expression" serializationversion="1">
                <property name="text" class="String">&gt;&gt;{
    "Path": "&lt;&lt;+urlEncode(year(now())+&gt;&gt;/&lt;&lt;+configurationVodafone.rootOutputSubfolder+&gt;&gt;/__Report ordini&lt;&lt;)+&gt;&gt;",
   "PathSharepoint": "&lt;&lt;+urlEncode(configurationVodafone.sharePointFolder)+&gt;&gt;",
   "ListName": "&lt;&lt;+configurationVodafone.listName+&gt;&gt;",
   "Filename": "&lt;&lt;+"ReportOrdiniVodafone_"+year(now())+"-"+month(now())+"-"+day(now())+"-"+replaceText(time(now()),":","-")+".xlsx"+&gt;&gt;",
   "User": "&lt;&lt;+configurationVodafone.user+&gt;&gt;",
   "Domain": "&lt;&lt;+configurationVodafone.domain+&gt;&gt;",
  "Password": "&lt;&lt;+configurationVodafone.password+&gt;&gt;",
