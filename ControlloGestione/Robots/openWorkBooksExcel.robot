                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "CLICK_OPEN_WORKBOOK" }
                      }
                    },
                    "comment": {
                      "meta":{
                    ...
                    "expression": {
                      ...
                      "gizmo":{
                        "text": { "string": "CLICK_OPEN_WORKBOOK" }
                      }
                    },
                    "variable": {
                      "meta":{
                ...
                },
                {
                  ...
                  "gizmo":{
                    "name": {
                      ...
                      "gizmo":{
                        "customName": { "string": "Click Open Workbook" }
                      }
                    },
                    "comment": {
                      "meta":{
                                ...
                                "finder": {
                                  ...
                                  "gizmo":{
                                    ...
                                    "componentSelector": {
                                      ...
                                      "gizmo":{
                                        "text": { "string": "Hyperlink[name=\"Open Other Workbooks\"]" }
                                      }
                                    }
                                  }
                                }
