...
<object class="Robot" serializationversion="2">
  ...
  <property name="variables" class="Variables">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="4">ErrorMessage</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="6">folder</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="0"/>
      </property>
    ...
    <object class="Variable" serializationversion="1">
      <property name="name" class="String" id="7">typeBu</property>
      <property name="global" class="Boolean">true</property>
      <property name="initialAssignment" class="InitialVariableAssignment">
        <property name="type" idref="0"/>
      </property>
      ...
      <property name="initialAssignment" class="InitialVariableAssignment">
        ...
        <property name="assignments" class="AttributeAssignments">
          ...
          <property name="PathFolder" class="AttributeAssignment">
            <property name="attributeValue" class="String">\\To4eostkt01\RPA\controllo gestione\consultivi 2020\IT\Report CdG\RPA\Da Elaborare\CO_ATLRIT20</property>
            <property name="currentlyAssigned" class="Boolean">true</property>
            <property name="lastKnownAttributeType" idref="5"/>
          </property>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      ...
      <object class="Try" id="23">
        <property name="name" class="String" id="24">ErrorStep</property>
      </object>
      ...
      <object class="Transition" serializationversion="3" id="37">
        ...
        <property name="stepAction" class="LoopInExcel">
          <property name="loopDirection" class="LoopInExcel$LoopDirection" id="38">
      ...
      <object class="Transition" serializationversion="3" id="45">
        <property name="name" class="String" id="46">Store in Database</property>
        <property name="stepAction" class="StoreInDatabase" serializationversion="0">
          <property name="db" class="kapow.robot.plugin.common.support.expression.stringexpr.DBNameValueStringExpression">
            <property name="value" class="kapow.util.db.DBName">
              <property name="name" class="String" id="47">reply_rpa</property>
            </property>
          </property>
      ...
      <object class="Transition" serializationversion="3" id="52">
        <property name="name" class="String">Loop Rows</property>
        <property name="stepAction" class="LoopInExcel">
          <property name="loopDirection" idref="38"/>
          <property name="firstIndex" class="Integer">1</property>
        </property>
        <property name="elementFinders" class="ElementFinders">
          <object class="ExcelElementFinder">
      ...
      <object class="Transition" serializationversion="3" id="64">
        ...
        <property name="stepAction" class="TestValue" serializationversion="0">
          <property name="condition" class="Expression" serializationversion="1">
            <property name="text" class="String">cogeInputCreatePdf.FileName != "" || binaryToText(cogeInputCreatePdf.InputFile) != ""</property>
          </property>
        </property>
        <property name="elementFinders" idref="29"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0">
 ...
 "PathFrom": "&lt;&lt;+urlEncode(cogeInputCreatePdf.PathFolder)+&gt;&gt;",
  ...
  "Password": "&lt;&lt;+configurationWriteFile.Password+&gt;&gt;"
      ...
      <object class="Transition" serializationversion="3" id="82">
        <property name="name" class="String" id="83">Wait</property>
        ...
        <property name="stepAction" class="CallRESTWebService2" serializationversion="1">
          ...
          <property name="request" class="kapow.robot.plugin.common.stateprocessor.rest.PostRestRequest">
            <property name="body" class="kapow.robot.plugin.common.stateprocessor.rest.RawBodyContent">
              <property name="data" class="Expression" serializationversion="1">
                <property name="text" class="String">&gt;&gt;{
    "Path": "&lt;&lt;+urlEncode(cogeInputCreatePdf.PathTempConvert)+&gt;&gt;",
...
"SheetNameStart": "&lt;&lt;+cogeInputCreatePdf.NameStart+&gt;&gt;",
 ...
 "FilenameOutput": "&lt;&lt;+cogeResultExport.companyName+"_"+cogeResultExport.bu+".pdf"+&gt;&gt;",
   ...
   "Domain": "&lt;&lt;+configurationWriteFile.domain+&gt;&gt;",
  "Password": "&lt;&lt;+configurationWriteFile.Password+&gt;&gt;",
   "PathTemp": "&lt;&lt;+urlEncode(cogeInputCreatePdf.PathTempConvert)+&gt;&gt;"
}&lt;&lt;</property>
              </property>
              <property name="contentType" class="kapow.robot.plugin.common.support.mimetype.MIMETypeValueStringExpression">
                <property name="value" class="String">application/json</property>
  ...
  "Binary": "&lt;&lt;+binaryPdf+&gt;&gt;"}&lt;&lt;</property>
      ...
      <object class="Transition" serializationversion="3" id="90">
        <property name="name" class="String" id="91">Call REST Web Service</property>
        <property name="stepAction" class="CallRESTWebService2" serializationversion="1">
          <property name="urlProvider" class="kapow.robot.plugin.common.support.expression.multipletype.VariableExpression" serializationversion="2">
            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
 ...
 "PathFrom": "&lt;&lt;+urlEncode(configurationWriteFile.Root + "\\In_Elaborazione\\" +folder)+&gt;&gt;",
  ...
  "Password": "&lt;&lt;+configurationWriteFile.Password+&gt;&gt;"
      ...
      <object class="Transition" serializationversion="3" id="99">
        <property name="name" class="String" id="100">Generate Error</property>
        <property name="stepAction" class="GenerateError">
 ...
 "Path": "&lt;&lt;+urlEncode(configurationWriteFile.Root + "\\In_Elaborazione\\" +folder)+&gt;&gt;",
  ...
  "Password": "&lt;&lt;+configurationWriteFile.Password+&gt;&gt;"
      ...
      <object class="Transition" serializationversion="3" id="126">
        ...
        <property name="elementFinders" class="ElementFinders" id="127"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment">
          <null/>
        </property>
 ...
 "Path": "&lt;&lt;+urlEncode(configurationWriteFile.Root + "\\In_Elaborazione\\" +folder)+&gt;&gt;",
  ...
  "Password": "&lt;&lt;+configurationWriteFile.Password+&gt;&gt;"
      ...
      <object class="Transition" serializationversion="3" id="130">
        ...
        <property name="elementFinders" idref="127"/>
        <property name="errorHandler" class="ErrorHandler" serializationversion="0"/>
        <property name="comment">
          <null/>
        </property>
 ...
 "PathFrom": "&lt;&lt;+urlEncode(configurationWriteFile.Root + "\\In_Elaborazione\\" +folder)+&gt;&gt;",
  ...
  "Password": "&lt;&lt;+configurationWriteFile.Password+&gt;&gt;"
      ...
      <object class="BranchPoint" id="132"/>
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.multipletype.StringProcessorsExpression" serializationversion="0">
            <property name="dataConverters" class="DataConverters">
              ...
              <element class="ExtractList" serializationversion="0">
                <property name="pattern" class="kapow.robot.plugin.common.support.expression.stringexpr.PartialInputMatchingPatternValueStringExpression">
                  <property name="value" class="String">_(.*)_(.*)([0-9]{2})</property>
                </property>
                <property name="expression" class="String">$2</property>
              </element>
            </property>
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.multipletype.StringProcessorsExpression" serializationversion="0">
            <property name="dataConverters" class="DataConverters">
              <element class="GetVariable" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String" id="145">binaryPdf</property>
                </property>
              </element>
              <element class="ReplaceText">
                <property name="textToReplace" class="String">"\"</property>
        ...
        <property name="stepAction" class="AssignVariable" serializationversion="4">
          <property name="stringExpr" class="kapow.robot.plugin.common.support.expression.multipletype.StringProcessorsExpression" serializationversion="0">
            <property name="dataConverters" class="DataConverters">
              <element class="GetVariable" serializationversion="2">
                <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
                  <property name="name" class="String" id="165">binaryzip</property>
                </property>
              </element>
              <element class="ReplaceText">
                <property name="textToReplace" class="String">"\"</property>
 ...
 "PathFrom": "&lt;&lt;+urlEncode(configurationWriteFile.Root + "\\In_Elaborazione\\" +folder)+&gt;&gt;",
  ...
  "Password": "&lt;&lt;+configurationWriteFile.Password+&gt;&gt;"
      ...
      <object class="Transition" serializationversion="3" id="182">
        <property name="name" class="String" id="183">Send Email</property>
        <property name="stepAction" class="SendEmail">
          ...
          <property name="toAddress" class="kapow.robot.plugin.common.support.expression.multipletype.VariableExpression" serializationversion="2">
            <property name="variable" class="kapow.robot.plugin.common.support.AttributeName2">
              <property name="name" class="String">cogeInputCreatePdf.Mail</property>
            </property>
          </property>
          ...
          <property name="message" class="Expression" serializationversion="1">
            <property name="text" class="String">"Salve, la informiamo che il robot ha completato l’elaborazione con esito: "+ ErrorMessage+". 
