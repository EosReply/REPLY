      ...
      <object class="Transition" serializationversion="3" id="210">
        ...
        <property name="stepAction" class="SendEmail">
          ...
          <property name="message" class="Expression" serializationversion="1">
            <property name="text" class="String">
"Salve, 
la informiamo che il robot ha completato l’elaborazione del task creazione PDF con esito: "+ ErrorMessage+". 
Per eventuale assistenza tecnica contattare l’indirizzo mail: eos.rpa.support@reply.it.
Grazie, 
Saluti."</property>
          </property>
          <property name="mailServer" class="kapow.robot.plugin.common.support.expression.multipletype.VariableExpression" serializationversion="2">
